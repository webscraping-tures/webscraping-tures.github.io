...
* mutate() to apply lubridate and remove "Ereignisort: "
  * before that show some simple calculations
* select() to remove raw data/time columns and maybe text
* filter() for removing incomplete years
  * "should have done this before downloading"
* rename()
* group_by() + summarize
  * reports by year
  * (reports by month)

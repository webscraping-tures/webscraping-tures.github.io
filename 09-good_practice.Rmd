...
persons, we should anonymize any information that could lead to identification.
...
cannot directly anonymize the data during collection, we should do this after
collection.  Especially if results of the analysis or a constructed data set are
to be publicly released, anonymization is paramount.
